                ...
                <div class="flex flex-col flex-1 overflow-hidden"> 
                    ...
                    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                        <div class="container px-6 py-8 mx-auto min-h-screen flex-grow">
                            <h3 class="text-3xl font-bold text-gray-700 ">Silakan Tambah Kelas</h3>
                            ...
                            <div class="flex flex-col mt-auto">
                                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                    <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200">
                                        <form action="{{ route('kaprodi.kelas.store') }}" method="POST" class="bg-white shadow-lg rounded-lg p-8">
                                            @csrf
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <input type="text" name="jumlah" id="jumlah" value="{{ old('jumlah') }}" class="block w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-blue-300 focus:outline-none" required>
                                            </div>
                                            
                                            <div class="mb-4">
                                                <label for="dosen_id" class="block text-sm font-medium">Dosen Wali</label>
                                                <select name="dosen_id" id="dosen_id" class="block w-full p-3 border border-gray-300 rounded-lg focus:ring focus:ring-blue-300 focus:outline-none">
