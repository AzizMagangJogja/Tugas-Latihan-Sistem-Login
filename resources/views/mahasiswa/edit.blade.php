                            ...
                            <div class="flex flex-col mt-auto">
                                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                    <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200">
                                        <form action="{{ route('mahasiswa.update', $mahasiswa->id) }}" method="POST" class="bg-white shadow-lg rounded-lg p-8">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <select id="kelas_id" name="kelas_id" required class="block w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-300">
                                            ...
                                            <div class="flex space-x-4">
                                                <a href="{{ route('mahasiswa.index') }}" class="flex items-center justify-center w-24 text-base font-sans bg-red-600 text-white p-2 rounded-lg shadow hover:bg-red-800 transition duration-300 ease-in-out transform hover:scale-105">
