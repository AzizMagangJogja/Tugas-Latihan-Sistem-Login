            ...
            <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
                ...
                <div class="flex flex-col flex-1 overflow-hidden">
                    ...
                    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                        <div class="container max-w-4xl px-4 py-8 min-h-screen mx-auto flex-grow">
                            <h3 class="text-3xl font-bold text-gray-800 mb-6">Request Edit Data {{ Auth::user()->username }}</h3>
                        
                            <div class="flex flex-col mt-auto">
                                <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                                    <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200">
                                        <div class="bg-white shadow-lg rounded-lg p-6 mb-6">
                                            <form action="{{ route('mahasiswa.request.store') }}" method="POST">
                                                @csrf
                                                <div class="mb-6 w-full">
                                                    <label for="keterangan" class="block text-lg font-semibold text-gray-700 mb-2">Keterangan:</label>
                                                    <textarea name="keterangan" id="keterangan" rows="4" class="block p-3 w-full border border-gray-300 rounded-lg resize-y focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-300" required></textarea>
                                                </div>  
                                                
                                                <div class="flex space-x-4">
                                                    <a href="{{ route('mahasiswa.index') }}" class="flex items-center justify-center w-24 text-base font-sans bg-red-600 text-white p-2 rounded-lg shadow-lg hover:shadow-2xl hover:bg-red-700 transition duration-300 ease-in-out transform hover:scale-105">
                                                    ...
                                                    <button type="submit" class="flex items-center justify-center w-24 text-base font-sans bg-green-500 text-white p-2 rounded-lg shadow-lg hover:shadow-2xl hover:bg-green-600 transition duration-300 ease-in-out transform hover:scale-105">
                                                        <svg class="w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
